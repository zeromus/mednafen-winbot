rem BASED ON msys2_shell.cmd ; IT'S MODIFIED SOLELY FOR BUILDING MEDNAFEN!
rem NOT USEFUL AS A REFERENCE!

setlocal

set "WD=%__CD__%"\msys64
if NOT EXIST "%WD%msys-2.0.dll" set "WD=%~dp0msys64\usr\bin\"
...
:startmintty
..\msys64\usr\bin\bash.exe --login %1 %2 %3 %4 %5 %6 %7 %8 %9
exit /b %ERRORLEVEL%
